...
hive \
 ...
 -f /home/huanglei/script/huanglei/panda_stat/pgc/room_detail/room_detail.sql

/usr/local/php-5.6/bin/php /home/zhangyunhua/www/panda_work/Routine_state.php panda_stat.panda_stat_pgc_room_detail $enddate
